...
-a, --alt-host string         Alternate TELNET targets [username@host:port]
                                 (multiple allowed)
-d, --debug                   Debug TELNET negotiation
-L, --log-dir string          Base directory for logs (default "./log")
-o, --no-log                  Disable session logging
-c, --console-log string      Enable console logging [quiet, noquiet]
                                 (no default)
-C, --compress-algo string    Compression algorithm [gzip, lz4, xz, zstd]
                                 (default "gzip")
-s, --compress-level string   Compression level for gzip, lz4, and zstd
